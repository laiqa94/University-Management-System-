...
async function registerForCourse() {
    ...
    console.log(chalk.green("Student registered for course successfully"), student);
}
async function assignCourse() {
    ...
    console.log(chalk.green("Course assigned to instructor successfully"), instructor);
}
async function showList() {
    ...
    switch (answers.listType) {
        case "Students":
            ...
            students.forEach((student) => console.log(chalk.yellow(`\n\t Name: ${student.name}, Age: ${student.age}, Roll Number: ${student.rollNumber}, Courses: ${student.courses
                .map((course) => course.name)
                .join(", ")} \n`)));
            break;
        case "Instructors":
            console.log(chalk.blue.bold("\n\t List of Instructors: \n"));
            instructors.forEach((instructor) => console.log(chalk.green(`\n\t Name: ${instructor.name}, Age: ${instructor.age}, Salary: ${instructor.salary}, Courses: ${instructor.courses
                .map((course) => course.name)
                .join(", ")} \n`)));
            break;
        case "Courses":
            console.log(chalk.whiteBright("\n\t List of Courses: \n"));
            courses.forEach((course) => console.log(chalk.magenta(`\n\t ID: ${course.id}, Name: ${course.name}, Students: ${course.students
        ...
        case "Departments":
            ...
            departments.forEach((department) => console.log(chalk.blue(`\n\t Name: ${department.name}, Courses: ${department.courses
                .map((course) => course.name)
                .join(", ")} \n`)));
            break;
    }
